...
def reset_matplotlib():
    ...
    try:
        ...
        pass
#%% Fig 1F
data = sio.loadmat(r'S_HW_Norc3_sym_4day_CF.mat')
...
#fig2 = plt.figure(figsize=(20,10),dpi=60, facecolor='w', edgecolor='k')
    ...
    plt.ylim([-51,51])
    plt.xlim([-50,50])
#    plt.xticks(fontname = "Calibri",fontsize=30,fontweight="bold")
#    plt.yticks(fontname = "Calibri",fontsize=30,fontweight="bold")
    ax.spines['right'].set_visible(False)
    ax.spines['top'].set_visible(False)
    ax.xaxis.set_label_coords(0.5, -0.13)
    ax.yaxis.set_label_coords(-0.13, 0.5)
