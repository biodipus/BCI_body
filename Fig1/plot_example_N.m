...
%% fig 1F
load('D:\Projects\MI\BCI_data\Monkey_data\Behavior\N_beha_sessions.mat')
rot = [-45,-35,-20,-10,0,10,20,35,45]';
hw = reach;
days = unique(hw(:,1));
a = [8:11]; 
...
%% fig S1E
load('D:\Projects\MI\BCI_data\Monkey_data\Behavior\N_beha_sessions.mat')
rot = [-90, -55,-35,-20,-10,0,10,20,35,55, 90]';
hw = reach;
days = unique(hw(:,1));
a = [4]; 
k = 1;
